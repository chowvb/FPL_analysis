"""
This script solely has the purpose of testing new code and debugging code. No new code will be saved or committed from this file.
"""
import csv, json
import pandas as pd
...
season_list = ["2016-2017", "2017-2018", "2018-2019", "2019-2020", "2020-2021", "2021-2022", "2022-2023"]
...
for season in season_list:
    ...
    gw_df = gw_df[["name", "GW", "goals_scored", "assists", "total_points", "value"]]
    gw_df["season"] = season
    gw_df.fillna(0)
